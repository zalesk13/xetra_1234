...
class TestXetraETLMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Creating S#BucketConnector Instances 
        ...
        columns_src = ['ISIN', 'Mnemonic', 'Date', 'Time',
            'StartPrice', 'EndPrice', 'MinPrice', 'MaxPrice', 'TradedVolume']
        data = [['AT000A0E9W5', 'SANT', '2021-04-15', '12:00', 20.19, 18.45, 18.20, 20.33, 877],
                ['AT000A0E9W5', 'SANT', '2021-04-16', '15:00', 18.27, 21.19, 18.27, 21.34, 987],
                ['AT000A0E9W5', 'SANT', '2021-04-17', '13:00', 20.21, 18.27, 18.21, 20.42, 633],
                ['AT000A0E9W5', 'SANT', '2021-04-17', '14:00', 18.27, 21.19, 18.27, 21.34, 455],
                ['AT000A0E9W5', 'SANT', '2021-04-18', '07:00', 20.58, 19.27, 18.89, 20.58, 9066],
                ['AT000A0E9W5', 'SANT', '2021-04-18', '08:00', 19.27, 21.14, 19.27, 21.14, 1220],
                ['AT000A0E9W5', 'SANT', '2021-04-19', '07:00', 23.58, 23.58, 23.58, 23.58, 1035],
                ['AT000A0E9W5', 'SANT', '2021-04-19', '08:00', 23.58, 24.22, 23.31, 24.34, 1028],
                ['AT000A0E9W5', 'SANT', '2021-04-19', '09:00', 24.22, 22.21, 22.21, 25.01, 1523]]
    ...
    def test_transform_report1_ok(self):
        ...
        # Method execution
        with patch.object(MetaProcess, "return_datye_list",
            return_value=[extract_date, extract_date_list]):
            xetra_etl = XetraETL(self.s3_bucket_src, self.s3_bucket_trg,
                                 self.meta_key, self.source_config, self.target_config)
            with self.assertLogs() as logm:
    ...
    def test_load(self):
        ...
        """
        # Expected results
        log1_exp = 'Xetra Target successfully written.'
