...
def main():
    ...
    #config_path = r'C:\Users\jzale\OneDrive\Documents\Python\xetra_project\xetra_1234\configs\xetra_report1_config.yml'
    ...
    s3_config = config['s3']
    # creating the S3BucketConnector class instaces for source and target
