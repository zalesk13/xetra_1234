...
class MetaProcess():
    ...
    def update_meta_file(extract_date_list: list, meta_key: str, s3_bucket_meta: S3BucketConnector):
        ...
        df_new[MetaProcessFormat.META_SOURCE_DATE_COL.value] = \
    ...
    def return_date_list(first_date: str, meta_key: str, s3_bucket_meta: S3BucketConnector):
        ...
        already processed dates in the meta file

            first_date (str): the earliest date Extra data should be processed
            meta_key (str): key of the meta file on the S3 bucket
            s3_bucket_meta (S3BucketConnector): S3 bucket connector for the bucket with the meta file

        returns:
        min_date: first date that should be processed
        return_date_list: list of all dates from min_date to today
        """
        ...
        try:
            ...
            if dates_missing:
                # Determining the earliest date they should be extrcated
